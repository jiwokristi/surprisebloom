...
export const Testimonials = () => {
  useEffect(() => {
    ...
    tl.fromTo(
      ...
      .fromTo(
        '#animation-item-2',
        { yPercent: 100 },
        { yPercent: 10, duration: 8 },
        '<',
      )
      .fromTo(
        '#animation-item-3',
        { yPercent: 100 },
        { yPercent: 20, duration: 8 },
        '<',
      )

    // Optional: Add an onComplete callback to unpin the section when all animations are done
  ...
  return (
    <section
      ...
      className="mt-128 h-[60rem] overflow-hidden border-t border-gray-2/30 pt-48"
    >
      <div
